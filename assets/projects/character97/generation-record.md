...
The later 1600 x 1600, 240-frame input was keyed using a red/green channel swap around CorridorKey. Local red cleanup and forehead protection preceded the transparent master and linear-light black composite.

Delivered media: 1600 x 1600 / 24 fps / 240 frames / 10 s. No audio; black background baked into MP4.

## Limits and interpretation

Legacy filenames and UI titles mention seed 308848260085483 / 1.6x / 20p6. The actual API uses seed 322853979834763 / 2x / 20 base steps / split 6. The original 243-frame generation and later 240-frame keying input are different encodes; the intermediate chain is not fully reconstructed.
